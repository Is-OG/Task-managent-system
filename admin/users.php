...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action === "add") {
        ...
        if ($name === "" || $email === "" || $password === "") {
            ...
            if ($stmt->execute()) {
                ...
                $error = $stmt->errno === 1062 ? "That email is already registered." : "Could not create user.";
            }
            $stmt->close();
        }
    }
    ...
    if ($action === "delete") {
        ...
        if ($user_id === (int)$_SESSION["user_id"]) {
            ...
            /*
             * The database uses ON DELETE SET NULL for tasks.assigned_to.
             * Therefore assigned tasks remain in the system as Unassigned.
             */
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ((int)$user["id"] !== (int)$_SESSION["user_id"]): ?>
                                <form method="POST" class="inline-form delete-form" onsubmit="return confirm('Delete this user? Their assigned tasks will become unassigned.');">
